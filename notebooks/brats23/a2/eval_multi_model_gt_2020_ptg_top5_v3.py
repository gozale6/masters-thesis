...
def main():
    ...
    log_path = Path("logs") / f"eval_multi_v3_{ts}.log"
    ...
    log.info("=" * 70)
    log.info("Field-wise multi-model evaluation (v3)")
    log.info("=" * 70)
