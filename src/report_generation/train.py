...
Usage
-----
    python train_multi_model_gt_2020_ptg_v4.py --model scifive-base        # test one first
...
def main():
    ...
    for k in ["csv", "text_dir", "output_root", "model", "epochs", "patience",
              ...
              "min_fields", "lora_r", "lora_widen", "lobe_rollup", "select_metric",
              "content_check_n", "aug_preset", "shuffle_mode", "p_swap", "p_shuffle", "skip_done"]:
    ...
    for i, s in enumerate(rank, 1):
        ...
        log.info(f"  {i}. {s['model_key']:<22}{tag} val_loss={s['best_val_loss']:.4f}{cstr}  "
