...
# ============================================================================
# Configuration - SegResNet for BraTS 2023
# ============================================================================

class Config:
    # Data
    train_json = "../train_list_no2020.json"
    val_json = "../val_list_2020.json"

    # Model - SegResNet parameters (based on Myronenko 2018 paper)
    ...
    blocks_down = (1, 2, 2, 4)   # Encoder blocks per stage
    blocks_up = (1, 1, 1)        # Decoder blocks per stage
    ...
    # Logging
    log_dir = "./logs_segresnet_filtered_20"
    checkpoint_dir = "./checkpoints_segresnet_filtered_20"
    log_interval = 20
...
# ============================================================================
# Logger Class (Same as SwinUNETR)
# ============================================================================
...
class TrainingLogger:
    ...
    def __init__(self, log_dir, checkpoint_dir):
        ...
        self.log("="*80)
        self.log("Training Session Started - SegResNet")
    ...
    def log_model_info(self, model):
        ...
        self.log("\nModel Information:")
        self.log("-" * 80)
        self.log(f"  Architecture: SegResNet")
...
# ============================================================================
# Data Transforms (Same as SwinUNETR)
# ============================================================================
...
# ============================================================================
# Training Functions (Same as SwinUNETR)
# ============================================================================
...
def main():
    ...
    logger.log("="*80)
    logger.log("SegResNet Training - BraTS 2023")
    logger.log("="*80)
